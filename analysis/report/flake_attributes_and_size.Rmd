...
flakes_clustered_cats <- 
  flakes_clustered_cats %>% 
  mutate(type3 = if_else(str_detect(type1, "lv|lev"), "levallois", type1)) %>% 
  mutate(type3 = if_else(str_detect(type1, "ret"), "retouch", type3)) %>% 
  mutate(type3 = if_else(str_detect(type1, "blade|bld"), "blade", type3)) 
