...
The majority of tools (`r retouch_edge_shapes_metrics_tally_1_edge`%) are retouched on only one edge of the artefact, and have only one layer of retouch on the worked edges (`r `number of layers`%).
